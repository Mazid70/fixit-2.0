...
export default function NotificationsPage() {
  ...
  const fetchPage = (p) => {
    fetchNotifications(p, false, pageSize);
    window.scrollTo({ top: 100, behavior: 'smooth' });
  };

  const handlePageSizeChange = (newSize) => {
    if (setPageSize) setPageSize(newSize);
    fetchNotifications(1, false, newSize);
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-neutral-400 mt-1">
            Real-time updates regarding your repair orders, scheduling alerts,
            and platform dispatches.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <Pagination
            ...
            totalItems={totalNotifications || notifications.length}
