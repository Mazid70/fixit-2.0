  ...
  return (
    <div className="space-y-24 pb-24 overflow-hidden bg-[#0a0c10] text-neutral-100 selection:bg-orange-500 selection:text-white">
      ...
      >
        ...
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[850px] h-[500px] bg-gradient-to-r from-orange-500/20 via-amber-500/15 to-cyan-500/10 blur-[140px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative w-full z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            {/* Right Column: Multi-Layer Showcase with Custom Realistic Assets */}
            <div className="lg:col-span-6 relative flex justify-center items-center min-h-[380px] sm:min-h-[460px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-orange-500/15 via-transparent to-cyan-500/15 rounded-3xl blur-2xl pointer-events-none" />
              ...
              {/* Layer 3: Floating Badge 1 (Bangladesh Smart City Context) */}
              <div className="hidden sm:flex items-center gap-3 absolute -bottom-6 -left-6 z-20 p-3 rounded-2xl bg-[#141824]/95 backdrop-blur-xl border border-orange-500/30 shadow-2xl max-w-xs">
                <img
              ...
              {/* Layer 4: Floating Badge 2 (Smart Service Dispatch) */}
              <div className="hidden sm:flex items-center gap-3 absolute -top-6 -right-6 z-20 p-3 rounded-2xl bg-[#141824]/95 backdrop-blur-xl border border-cyan-500/30 shadow-2xl max-w-xs">
