...
export default function AdminBookingsPage() {
  ...
  const fetchBookings = async (p = 1, limit = pageSize) => {
    try {
    ...
    <div className="w-full max-w-5xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-neutral-400 mt-1">
          Full global log of all customer booking transactions, service
          schedules, and status lifecycles.
        </p>
      </div>
              ...
              <tbody className="divide-y divide-neutral-800/60">
                {filtered.map(b => (
                  ...
                  >
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <p className="text-[11px] text-orange-400 font-semibold">
                          ৳
                          {b.service?.price
                            ? Number(b.service.price).toLocaleString('en-US')
                            : '0'}
                        </p>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <p className="font-medium text-neutral-200">
                        {b.provider?.business_name || 'Specialist'}
                      </p>
                    </td>
