    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 min-h-screen">
      ...
      {loading ? (
        ...
        <div className="flex flex-col justify-between min-h-[640px] space-y-8">
          ...
          {/* Fixed-Position Bottom Pagination */}
          {totalPages > 1 && (
            <div className="mt-auto pt-6 pb-2 border-t border-[#1c2230] flex flex-col sm:flex-row items-center justify-between gap-4">
              <span className="text-xs text-neutral-400 font-medium">
                Page <strong className="text-white">{currentPage}</strong> of{' '}
                <strong className="text-white">{totalPages}</strong> ({filteredProviders.length} total specialists)
              </span>
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-[#12151e] border border-[#212635] text-xs font-semibold text-neutral-300 hover:text-white hover:border-orange-500/50 disabled:opacity-30 disabled:pointer-events-none flex items-center gap-1 transition"
