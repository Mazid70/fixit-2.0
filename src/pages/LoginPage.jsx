...
export default function LoginPage() {
  ...
  const [activeTab, setActiveTab] = useState(isRegisterInitial ? 'register' : 'login');
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      ...
      addToast(`Welcome to FIXIT, ${user.name}! Your account is ready.`, 'success');
      navigate('/dashboard/customer');
    } catch (err) {
            ...
            <div className="space-y-4 pt-4">
              <div className="flex items-center gap-3">
                ...
                <div className="text-xs">
                  ...
                  <span className="text-neutral-400">Pros dispatched today</span>
                </div>
              </div>
            ...
            <div className="bg-[#10131b]/90 backdrop-blur-xl border border-[#1f2433] rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
              ...
              <div className="flex items-center gap-6 border-b border-[#1c2230] pb-2">
                ...
                >
                  LOGIN
                  {activeTab === 'login' && (
                    <span className="absolute bottom-0 left-0 w-full h-[3px] bg-orange-500 rounded-full -mb-[9px]" />
                  )}
                </button>
              ...
              {activeTab === 'login' && (
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    />
                    <label htmlFor="staySignedIn" className="text-xs text-neutral-400 select-none cursor-pointer">
              ...
              {activeTab === 'register' && (
                <form onSubmit={handleRegisterSubmit} className="space-y-4">
                  ...
                  <p className="text-[11px] text-neutral-400 leading-relaxed bg-[#151924] p-3 rounded-xl border border-[#232838]">
                    💡 All new members register as normal users. Want to offer services? You can apply to become a certified service partner anytime from your profile or navbar.
                  </p>
